...
stargazer(reg, type = "latex",
          ...
          covariate.labels = c("Male Adults", "Female Adults", "Head's Age", "Head's Education", "Distance to Health Center (km)", "Distance to School (km)", "Land Owned"),
...
ggplot(nichh, aes(x = headeduc, y = headage)) +
  geom_point() +
